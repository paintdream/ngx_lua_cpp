...
```lua
	init_worker_by_lua_block {
		...
		package.cpath = package.cpath .. ";[[ngx_lua_cpp binary directory]]/?.dll;[[ngx_lua_cpp binary directory]]/?.so;"
		require("init_ngx_lua_cpp")
	}
```

**init_gnx_lua_cpp.lua** is a lua module shared by all requests. It initialize a **ngx_lua_cpp** instance and return it as its module instance. 
...
You could use coroutines and warp(strand) system from iris library, which are fully compatible with OpenResty/Nginx's task scheduler.